...
export default function Messages() {
  ...
  return (
    <motion.main
      className="container !h-[80vh] flex-col items-center flex px-4 overflow-y-auto scrollbar-thin scrollbar-thumb-transparent scrollbar-track-transparent hover:scrollbar-thumb-gray-500 hover:scrollbar-track-gray-200 md:px-16 py-8"
